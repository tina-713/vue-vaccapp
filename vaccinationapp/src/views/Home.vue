<template>
  <div class="container-fluid">
      <div class ="row">
      <div class="col-sm">
        <p align="center" style="font-size:20px; font-weight:bold">Cazuri Zilnice Romania</p>
      ...
      <div class="col-sm">
        <p align="center" style="font-size:20px; font-weight:bold">Numar Cumulativ Cazuri Romania</p>
