            ...
            <v-card elevation="0">
              ...
              <v-card-text>
                <v-form>
                  ...
                  <v-text-field label="Introduceți parola" name="password" prepend-inner-icon="mdi-lock" type="password" class="rounded-0" outlined v-model="password" value="password"></v-text-field>
